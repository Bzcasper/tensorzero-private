...
- [Audio understanding](https://ai.google.dev/gemini-api/docs/audio.md.txt): Gemini API documentation
- [Available regions for Google AI Studio and Gemini API](https://ai.google.dev/gemini-api/docs/available-regions.md.txt): Gemini API documentation
- [Billing](https://ai.google.dev/gemini-api/docs/billing.md.txt): Gemini API documentation
- [Context caching](https://ai.google.dev/gemini-api/docs/caching.md.txt): Learn how to use Context Caching in the Gemini API
- [Embeddings](https://ai.google.dev/gemini-api/docs/embeddings.md.txt): Gemini API documentation
...
- [Image generation with Gemini (aka Nano Banana &amp; Nano Banana Pro)](https://ai.google.dev/gemini-api/docs/image-generation.md.txt): Get started generating images with the Gemini API using Nano Banana and Nano Banana Pro
...
- [ReAct agent from scratch with Gemini 2.5 and LangGraph](https://ai.google.dev/gemini-api/docs/langgraph-example.md.txt): Building LangGraph Agents with Gemini
- [LearnLM](https://ai.google.dev/gemini-api/docs/learnlm.md.txt): Gemini API documentation
- [Live API capabilities guide](https://ai.google.dev/gemini-api/docs/live-guide.md.txt): Gemini API documentation
- [Gemini models](https://ai.google.dev/gemini-api/docs/models.md.txt): Learn about Google&#39;s most advanced AI models including Gemini 2.5 Pro
...
- [Prompt design strategies](https://ai.google.dev/gemini-api/docs/prompting-strategies.md.txt): Gemini API documentation
...
- [Rate limits](https://ai.google.dev/gemini-api/docs/rate-limits.md.txt): Gemini API documentation
- [Safety guidance](https://ai.google.dev/gemini-api/docs/safety-guidance.md.txt): Gemini API documentation
- [Speech generation (text-to-speech)](https://ai.google.dev/gemini-api/docs/speech-generation.md.txt): Get started generating audio with the Gemini API
- [Understand and count tokens](https://ai.google.dev/gemini-api/docs/tokens.md.txt): Gemini API documentation
- [Troubleshoot Google AI Studio](https://ai.google.dev/gemini-api/docs/troubleshoot-ai-studio.md.txt): Gemini API documentation
- [Troubleshooting guide](https://ai.google.dev/gemini-api/docs/troubleshooting.md.txt): Gemini API documentation
- [Additional usage policies](https://ai.google.dev/gemini-api/docs/usage-policies.md.txt): Gemini API documentation
...
- [Customer Support Analysis with Gemini 2.5 Pro and CrewAI](https://ai.google.dev/gemini-api/docs/crewai-example.md.txt): Building CrewAI Agents with Gemini
...
- [Files API](https://ai.google.dev/gemini-api/docs/files.md.txt): Gemini API documentation
...
- [Research Agent with Gemini 2.5 Pro and LlamaIndex](https://ai.google.dev/gemini-api/docs/llama-index.md.txt): Building Research Agents with Gemini
- [Long context](https://ai.google.dev/gemini-api/docs/long-context.md.txt): Learn about how to get started building with long context (1 million context window) on Gemini 2.0 Flash
...
- [OpenAI compatibility](https://ai.google.dev/gemini-api/docs/openai.md.txt): Gemini API documentation
...
- [Gemini thinking](https://ai.google.dev/gemini-api/docs/thinking.md.txt): Gemini API documentation
- [URL context](https://ai.google.dev/gemini-api/docs/url-context.md.txt): Gemini API documentation
- [Grounding with Google Maps](https://ai.google.dev/gemini-api/docs/maps-grounding.md.txt): Ground your model&#39;s responses in rich, real-world data from Google Maps to provide factually accurate, location-aware answers